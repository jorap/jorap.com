...
| 10 | **Meta / SEO** — `description` memorable, not keyword-stuffed; `social_media_intro` ≤200 chars, hook → payoff → CTA (article in comments; no article-first opener); `image_prompt` paste-ready hero generation | frontmatter |
