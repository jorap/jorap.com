...
(function () {
  ...
  function buildPrompt(topic) {
    ...
    return [
      ...
      "- Opening line (**Term** = one-breath definition)",
      "- ## Key Concept (stakes, distinctions, wikilinks; not a second definition)",
      ...
      "   Opening line:",
      "   - **Title** = one-breath definition (what it is — quotable, no wikilink dump).",
      "",
      "   ## Key Concept:",
      "   - Why this note matters: stakes, distinctions from neighbors, [[wikilinks]] to the graph.",
      "   - Not a second definition. If you need a second claim, that's another note.",
      "",
