...
ADD: dict[str, list[tuple[str, str, str]]] = {
    ...
    # Galatians fruit cluster
    "faithfulness": [
        ("extends", "Compounding", "Small faithful use stacks over quiet Tuesdays"),
        ("extends", "Discipleship", "Daily following is where faithfulness shows up"),
        ("extends", "Eternal Rewards", "Well done may repay steady faithfulness - not the entry fee"),
        ("extends", "Faithful Steward", "Faithful steward is the garden echo for gospel faithfulness"),
        ("extends", "Follow-Through", "Faithfulness fruit after the handshake - owners and dates"),
        ("extends", "Fruits of the Spirit", "Galatians names faithfulness in the Spirit-grown cluster"),
    ],
    "gentleness": [
        ("alternative", "Self-Control", "Restraint skill vs Spirit-grown gentleness in tone"),
        ("contradicts", "Let Your Light Shine", "when grabbing the spotlight replaces serving without strutting"),
        ("extends", "Composure", "Gentleness fruit keeps steady voice under pressure"),
        ("extends", "Fruits of the Spirit", "Galatians names gentleness in the Spirit-grown cluster"),
        ("extends", "Humility and Service", "Humility and service is the garden echo for gospel gentleness"),
        ("extends", "Listen Before Fixing", "Gentleness fruit hears before prescribing the fix"),
        ("extends", "Patience", "Same cluster - slow fuse and soft tone together"),
        ("extends", "The Beatitudes", "Meek inherit the earth - gentleness Jesus blessed"),
    ],
    "goodness": [
        ("alternative", "By Their Fruits", "Same word fruit - discern teachers by outcome vs Spirit-grown deeds"),
        ("contradicts", "Secret Devotion", "when I hide every good work that should point to God"),
        ("extends", "Faith and Works", "Good works prove faith alive - motive is thanks not wages"),
        ("extends", "Fruits of the Spirit", "Galatians names goodness in the Spirit-grown cluster"),
        ("extends", "Heart Righteousness", "Goodness fruit matches inner motive to outward deed"),
        ("extends", "Let Your Light Shine", "Let your light shine is the garden echo for gospel goodness"),
    ],
    "joy": [
        ("contradicts", "Compounding", "when a good-week streak masquerades as gospel joy"),
        ("extends", "Abide in Me", "Gladness grows from staying in the vine - not self-stacked effort"),
        ("extends", "Assurance", "Joy fruit rests on Christ's promise - not this week's score"),
        ("extends", "Free Grace", "Joy follows grace received - not wages that buy heaven"),
        ("extends", "Fruits of the Spirit", "Galatians names joy in the Spirit-grown cluster"),
        ("extends", "Grateful Obedience", "Thanks-motivated walk produces joy - not performed credit"),
        ("extends", "Standing vs Fellowship", "Bad week may break closeness - joy still anchors on Christ's promise"),
    ],
    "kindness": [
        ("contradicts", "Judge Not", "when kindness avoids truth and leaves someone unhelped"),
        ("extends", "Fruits of the Spirit", "Galatians names kindness in the Spirit-grown cluster"),
        ("extends", "Love Your Enemies", "Kindness fruit when it's hard - bless persecutors"),
        ("extends", "Love Your Neighbor", "Kindness fruit outward - second commandment pair"),
        ("extends", "Mercy", "Kindness fruit toward the person in front of me"),
        ("extends", "The Beatitudes", "Merciful obtain mercy - kindness Jesus blessed"),
        ("extends", "The Golden Rule", "Tender regard I'd want if roles reversed"),
    ],
    "patience": [
        ("contradicts", "Ship It", "when rush skips the beat patience needs"),
        ("extends", "Abide in Me", "Slow fuse grows from staying in the vine - not willpower alone"),
        ("extends", "Discipleship", "Daily following is where patience shows up with real people"),
        ("extends", "Emotional Regulation", "Patience fruit needs the spike named before the act"),
        ("extends", "Fruits of the Spirit", "Galatians names patience in the Spirit-grown cluster"),
        ("extends", "Gentleness", "Same cluster - power restrained in tone and timing"),
        ("extends", "Sanctification", "Becoming holy over time - patience marks the slow walk"),
        ("extends", "Slow the Moment", "Patience fruit - one beat before reaction"),
    ],
    "peace": [
        ("contradicts", "Love Your Enemies", "when I confuse peace with never confronting wrong"),
        ("extends", "Don't Worry", "Peace fruit when anxiety replaces trust"),
        ("extends", "Fruits of the Spirit", "Galatians names peace in the Spirit-grown cluster"),
        ("extends", "Peacemakers", "Peacemakers is the active echo for gospel peace"),
        ("extends", "Seek the Kingdom First", "God's reign orders the week before worry sets panic"),
        ("extends", "The Beatitudes", "Peacemakers blessed - kingdom peace made visible"),
    ],
