...
EASY: list[tuple[str, str]] = [
    ...
    ("What fruit is purple or green?", "grape"),
    ("What flies and has colorful wings?", "moth"),
...
MEDIUM: list[tuple[str, str]] = [
    ...
    ("What room has a tub?", "bath"),
    ("What do you wear in the rain?", "coat"),
    ("What do cats like to chase?", "mice"),
    ("What do you hang on a wall?", "art"),
    ("What do you put photos in?", "album"),
    ("What holds hot cocoa?", "mug"),
    ("What game piece do you roll?", "dice"),
...
HARD: list[tuple[str, str]] = [
    ...
    ("What dark cloud brings thunder?", "storm"),
    ("What grows on a cactus?", "spine"),
    ("What do climbers scale?", "cliff"),
    ("What do sailors steer?", "helm"),
...
META = {
    ...
    "mode": "quiz",
    "tagline": "Animals, colors, and facts — no arithmetic. Every answer is 3 to 5 letters.",
    "play_hint": (
