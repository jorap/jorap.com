...
shareable_thought:
  ...
  - "Calm urgency beats either panic or drift."
  - "Care means the people counting on you still feel seen when the pressure spikes."
relationships:
  - type: contradicts
  ...
  - type: extends
    ...
    reason: "Horizontal care vs vertical following - title does not replace Christ"
  - type: extends
  ...
  - type: extends
    ...
    reason: "Safety floor leaders do not trade away"
  - type: extends
