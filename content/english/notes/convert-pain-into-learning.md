...
relationships:
  - type: contradicts
    ...
    reason: "when re-analyzing the wound becomes an excuse not to release or move on"
  - type: extends
  ...
  - type: extends
    ...
    reason: "Learning starts with honest naming"
  - type: extends
    wikilink: "[[Pressure Reveals Weakness]]"
    reason: "Hard moments are the curriculum"
