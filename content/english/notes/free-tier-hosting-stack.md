...
key_concept: |
  - Free tier is not unlimited - re-read Cloudflare limits before quoting anything to a client.
  - Hard caps on the free plan: about **500 builds per month** (whole account, not per site).
  - **1 concurrent build** - second push waits in line.
