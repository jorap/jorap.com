...
relationships:
  - type: contradicts
    ...
    reason: "when naming the feeling becomes a substitute for closing the loop"
  - type: extends
    wikilink: "[[Emotional Regulation]]"
    reason: "Naming helps me and them before the spike drives the reply"
  - type: extends
    wikilink: "[[Listen Before Fixing]]"
    reason: "I hear first, then label what I heard"
  - type: implements
    wikilink: "[[Break the Escalation Cycle]]"
    reason: "A calm label can cool a thread before snark stacks"
...
cards:
  ...
  - front: "Saw the slump - launched straight into the adjustment. What's the move?"
    back: "Name the feeling - then coach."
  - front: "Spouse tense - I'm stacking fixes before hello. First fix?"
    back: "You look shot - traffic or errands?"
  - front: "Bad quarter means lazy - say it straight. One check?"
    back: "You look frustrated - what's heavy?"
  - front: "Kid crying - I'm problem-solving through the tears. What comes first?"
