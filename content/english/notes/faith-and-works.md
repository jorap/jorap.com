...
relationships:
  ...
  - type: extends
    ...
    reason: "Works flow from following - faith at work shows up in obedience"
  - type: extends
    wikilink: "[[Free Grace]]"
    reason: "Faith saves; works answer the gift, not the price"
  - type: extends
    wikilink: "[[Goodness]]"
    reason: "Good works answer grace - motive is thanks not wages"
  - type: extends
    wikilink: "[[Grateful Obedience]]"
    reason: "Works answer grace - motive is thanks, not wages"
  - type: extends
    wikilink: "[[Justification]]"
    reason: "Declared righteous at faith before God; works show faith before people"
  - type: extends
