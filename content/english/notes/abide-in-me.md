...
shareable_thought:
  ...
  - "Fruit comes from staying connected, not willpower theater."
...
relationships:
  ...
  - type: extends
    ...
    reason: "Abiding produces the Galatians cluster - love through self-control"
  - type: extends
    wikilink: "[[Joy]]"
...
cards:
  ...
  - front: "No prayer, no Scripture all week - patience snapped at someone. Apart from the vine, what can I produce?"
