...
shareable_thought:
  ...
  - "Pass-off models (pick one with Plain Commitments at Work clarity): see Client Site Pass-Off."
relationships:
  - type: contradicts
  ...
  - type: extends
    ...
    reason: "Client sites are shipped output, not notes hoarded in the garden"
  - type: extends
