...
level_1: "Energy protects judgment because tired minds make worse calls than rested minds on the same facts - sleep and recovery are part of performance."
...
relationships:
  ...
  - type: extends
    ...
    reason: "Tired brains trade accuracy for speed"
  - type: extends
    wikilink: "[[Develop, Don't Endanger]]"
    reason: "Sustainable load vs glorified exhaustion"
  - type: extends
    wikilink: "[[Minimum Effective Dose]]"
    reason: "Enough effort to perform - not heroics past the dose"
  - type: extends
