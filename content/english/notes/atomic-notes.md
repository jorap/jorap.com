...
relationships:
  - type: alternative
    ...
    reason: "Single file per idea vs one bubble map when splitting early"
  - type: contradicts
...
cards:
  ...
  - front: "Cannot say the whole note in one breath without using 'and'. What's wrong?"
  ...
  - front: "Cannot link to one idea buried in a kitchen-sink note. What's the fix?"
