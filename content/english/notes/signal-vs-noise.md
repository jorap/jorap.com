...
relationships:
  - type: alternative
    ...
    reason: "Filter at save vs curate after capture"
  - type: contradicts
    wikilink: "[[Capture]]"
    reason: "when I save first and filter later"
  - type: extends
    wikilink: "[[Information Diet]]"
    reason: "What you let in - filter frame next to capture"
  - type: extends
    wikilink: "[[Renewed Mind]]"
    reason: "Kingdom signal before culture noise enters the mind"
