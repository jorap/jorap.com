...
relationships:
  - type: contradicts
    ...
    reason: "when I defer handoff choice until launch and hope they adapt"
  - type: extends
    wikilink: "[[Git-Based CMS]]"
    reason: "Fourth handoff path when buttons beat terminal"
  - type: extends
    wikilink: "[[Plain Commitments at Work]]"
    reason: "One publish model named before deposit"
  - type: extends
    wikilink: "[[Selling Static Sites]]"
    reason: "Handoff is priced separately from build setup"
  - type: extends
