...
relationships:
  ...
  - type: extends
    wikilink: "[[Mercy]]"
    reason: "Mercy spares wrath; grace gives good - paired in the same rescue"
  - type: extends
    wikilink: "[[Minimum Effective Dose]]"
    reason: "Faith is the one sufficient act grace accepts - not a merit ladder"
  - type: extends
    wikilink: "[[Sanctification]]"
    reason: "Grace sustains growth after the verdict, not before it"
  - type: extends
    wikilink: "[[Standing vs Fellowship]]"
    reason: "Grace settles standing at faith; fellowship fluctuates with sin and confession"
slug: "grace"
