...
relationships:
  - type: contradicts
    ...
    reason: "when rough ship beats two-year polish"
  - type: extends
...
cards:
  ...
  - front: "Feature list grew again - users still haven't touched v1. What's the move?"
    back: "Cut to one path - ship what teaches."
  - front: "Logo and landing page perfect - nobody can actually use it yet. What's the move?"
