...
relationships:
  - type: contradicts
    ...
    reason: "Absorb the hit vs cut losses - cheek is not sunk-cost denial"
  - type: contradicts
...
cards:
  ...
  - front: "Eye-for-eye feels fair right now. What's the break?"
    back: "Refuse payback - don't become what hurt me."
  - front: "Waiting to hit back before I act well toward them. What comes first?"
    back: "Break cycle - do not return evil."
  - front: "Public slap to my reputation - outrage justified in my head. Next move?"
    back: "Do not hit back - do not mirror evil."
