...
## Pia, Isaiah, and the kitchen

| Fact | Where I said it |
| :--- | :--- |
| My wife is **Pia**. Our family nickname is **Team Rapusas**. | [The Miracle of Isaiah David](/blog/miracle-isaiah-david/) |
| On **May 8, 2020**, Pia and I found out she was pregnant and gave birth to our son **Isaiah David** the same day - during strict **ECQ** lockdown in the Philippines. | [The Miracle of Isaiah David](/blog/miracle-isaiah-david/) |
| His full name is **Isaiah David**; we call him **Davis** at home and in casual posts. | [Why I Love Modern Board Games](/blog/why-i-love-modern-board-games/), [The Miracle of Isaiah David](/blog/miracle-isaiah-david/) |
| Isaiah was born at **4:46 PM** via C-section, full-term at **3.2 kg**, APGAR **9**. I briefly announced the wrong gender before the doctors corrected me. | [The Miracle of Isaiah David](/blog/miracle-isaiah-david/) |
...
| Before Toca, Davis played **Stick War** on that phone - roleplaying **Archidons** and **Speartons** on the couch. We pulled it - war theme plus ads between battles. | [Why My Son Loves Toca Boca World](/blog/why-my-son-loves-toca-boca-world/) |
...
| Attended **WordCamp Asia in Manila** (~1,400 people) and heard Matt Mullenweg tell old **Philippines WordCamp** stories. | [Why I Switched from Drupal to WordPress](/blog/drupal-to-wordpress/) |
| Lost **shared PHP hosting** when a client moved on, then migrated to **Hugo + GitHub + Cloudflare Pages**. | [How I Built JoRap Notes](/blog/how-i-built-jorap-notes/), [Sustainable Online Publishing](/blog/sustainable-online-publishing/) |
| A git push to this site goes live in about **ninety seconds**. | [How I Built JoRap Notes](/blog/how-i-built-jorap-notes/), [Static Site or CMS?](/blog/static-site-vs-cms/) |
| I pin **`HUGO_VERSION`** (and **`NODE_VERSION`**) on Cloudflare to match local builds - mismatch is the most boring deploy failure. | [How I Built JoRap Notes](/blog/how-i-built-jorap-notes/), [HugoPlate Theme Review](/blog/hugoplate-theme-review/) |
| Hugo theme folder names are **case-sensitive** (`hugoplate` not `HugoPlate`). I learned that the embarrassing way. | [How I Built JoRap Notes](/blog/how-i-built-jorap-notes/) |
...
| I used to edit **PHP on live servers via FTP/cPanel**; Git taught me `git checkout -- .` after a bad live edit. | [Why Git Is the Greatest Open Source Innovation](/blog/why-git-greatest-open-source-innovation/) *(draft)* |

---

## MacBook M4, Android, and Google's glue

| Fact | Where I said it |
| :--- | :--- |
| I run a **MacBook Pro M4** for paid work and an **11th-gen iPad** for couch reading and PDFs. | [Why I Prefer the Google Ecosystem](/blog/google-over-apple-ecosystem/), [Apple Is Strategically Late](/blog/apple-strategically-late/) *(draft)* |
| Daily driver is **Android** - **no iPhone**, **no smartwatch**. | [Why I Prefer the Google Ecosystem](/blog/google-over-apple-ecosystem/) |
| **One Google account** glues Gmail, Drive, Photos, Meet, and Calendar across Mac, Android, iPad, and **Linux**. | [Why I Prefer the Google Ecosystem](/blog/google-over-apple-ecosystem/) |
| Living room TV runs a **Mi Box S** (Android TV) - cheap smarts without rebuying Apple's stack. | [Why I Prefer the Google Ecosystem](/blog/google-over-apple-ecosystem/), [Mi Box S](/blog/mi-box-s/) *(draft)* |
| I use **Messenger** and **Viber** - not iMessage politics. | [Why I Prefer the Google Ecosystem](/blog/google-over-apple-ecosystem/) |
| **Brave** for personal browsing, **Chrome** for client work and Meet screen shares. | [Why I Prefer the Google Ecosystem](/blog/google-over-apple-ecosystem/), [Why Brave Is My Personal Browser](/blog/why-brave-browser/) *(draft)* |
| **Brave Origin** on my **Linux** desktop (free there); regular Brave on Android. | [Why Brave Is My Personal Browser](/blog/why-brave-browser/) *(draft)* |
...
## Brave, Bitwarden, and a second phone
...
| Fact | Where I said it |
| :--- | :--- |
| I keep a **laptop** because I get real work done faster there - upright, keyboard, big screen. I don't lend it out; I use it all day. | [Why I Still Keep a Desktop or Laptop](/blog/why-keep-desktop-laptop/) |
...
| My everyday pair is **Soundpeats RunFree** (neckband, USB-C, open-ear). | [What I Look For in Wireless Earphones](/blog/what-i-look-for-in-wireless-earphones/) |
| I take **Google Meet** and **Messenger** calls on the same earphones I wear all day. | [What I Look For in Wireless Earphones](/blog/what-i-look-for-in-wireless-earphones/) |
...
## Acoustic guitar, VLC pads, and DNPAP
...
## Board games, Alex Eala, and quitting Marvel Snap
...
| I love **Hanamikoji** for the **I split, you choose** mechanic, not the geisha art. **Pia** and I play it on small desks while traveling. | [Hanamikoji Duopoly Retheme](/blog/hanamikoji-duopoly-retheme/), [Why I Love Modern Board Games](/blog/why-i-love-modern-board-games/) |
...
If you're new here and want the human version before the essays, start with the rows that sound most like a person and click through. If Pia, Davis, the Instant Pot, and the VLC pads all show up in the linked posts, it's probably still me typing.
...
The rows below are prompts for future me (or a curious reader). No links yet - that's the point.

---

## Pop culture I haven't pinned down

| Question | Why I'm asking |
| :--- | :--- |
| What show or film would I rewatch tonight without scrolling for twenty minutes? | Separates comfort picks from "I finished it once" picks. |
| What did I abandon after two episodes - and was it the show or my schedule? | I bail on long series fast. Worth knowing which bail was taste and which was life. |
| Anime or K-drama - do I watch either, or skip both? | I'm not a comics or anime person. Never wrote down whether K-drama is a separate lane or a hard no. |
| Music outside worship and OPM - what goes on repeat while I work? | Pia's on the DNPAP vocal. My solo listening habits are still a blank row. |
| Podcast or long YouTube essay - or is RSS enough? | I use Inoreader for blogs. Spoken-word taste is unmapped. |
| Last book I finished for fun, not for a client or a kid's homework. | Chapter books for grade 1 don't count. |
| PC game, emulator, or mobile-only since I quit Snap? | I said I won't play real games on a phone when a laptop is nearby. I never named what I actually launch. |
| I'm not a comics or anime person - so what pop culture actually lands with me? | Snap was a fluke. The rest of my taste is still unmapped. |
| Philippine pop culture I'd defend to a skeptic - teleserye, noontime show, old OPM, indie film. | Local taste shows up in the kitchen and worship posts, not much in entertainment. |
| One guilty pleasure I'd still watch if nobody asked. | The swap test for whether this site sounds like a person or a résumé. |

---

## Sports I play, watch, or only follow in headlines

| Question | Why I'm asking |
| :--- | :--- |
| What racket sport do I actually play - pickleball, badminton, table tennis, or "none lately"? | I wrote the small-room pick. I didn't say how often or with whom. |
...
| Something I played as a kid and would still join if someone organized it - softball, flag football, touch rugby, wiffle ball. | The streamlining post name-checks a dozen variants. My personal short list doesn't exist on this site. |
| A sport I respect but will never play - golf, marathon, surfing, esports. | Useful for knowing where enthusiasm ends and spectator mode begins. |
| Davis and sports - what am I teaching him, and what am I deliberately not pushing? | Strike with grandma is in the table. Organized sport isn't. |
