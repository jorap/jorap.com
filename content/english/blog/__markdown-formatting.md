...
Don't skip from H2 to H4 because it "looks smaller." Screen readers and Hugo's TOC care about hierarchy.

My pattern on longer posts:

- H2 for major sections (personality in the title when I can - "Flat plug, right-angle head" not "Plug Considerations")
