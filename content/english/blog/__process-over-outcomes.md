...
Sometimes you hit the number. Then what? Without a process, you're back to zero the next cycle.

---

## Process is a repeater

A process is **what you do on a Tuesday when motivation is average.**

- Publish weekly, not "viral once"
- Walk daily, not "10k steps before the wedding"
- Code review every PR, not "fix bugs before the demo"

Processes compound. Outcomes spike.
...
**Client work:** Checklists and templates beat reinventing delivery every project.

---

## When outcomes still lead
...
Outcomes are the scoreboard. Process is how you **get to play again next season.**

Optimize the process you can repeat. Let the outcomes take care of themselves more often than you'd expect.

*Expanded from the [James Clear](https://ideas.jorap.com/) tiddler on [ideas.jorap.com](https://ideas.jorap.com/).*
