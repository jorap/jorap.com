...
author: "JoRap"
tags: ["Publishing", "Self-Hosting", "Hugo", "TiddlyWiki", "Cloudflare Pages"]
draft: true
---

A front-end developer should be able to **showcase work on the web** without begging an algorithm for reach. Social accounts make starting easy — sign up, post, done.
