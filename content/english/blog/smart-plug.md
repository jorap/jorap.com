...
Most of mine stuck. A few didn't. Here's what I learned.
...
And schedules only work if **the physical device has a simple on/off behavior**. Some gear doesn't like being hard-cut from power. Read the manual. Seriously.
...
## Features I actually use vs. marketing fluff
...
Before I buy another smart plug:

1. Is this a simple on/off device that tolerates hard power cuts?
2. Is the outlet in decent wifi range?
3. Does it work with the ecosystem we already use?
4. Can I control it locally if the internet dies?
5. Will I actually use a schedule, or is this a one-week novelty?
